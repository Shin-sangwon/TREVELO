...
-- -----------------------------------------------------
-- Table `tripdb_test`.`room_detail`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tripdb_test`.`room_detail` (
...
CREATE TABLE IF NOT EXISTS `tripdb_test`.`reservation` (
  ...
  CONSTRAINT `roomdetail_to_payment`
    ...
    REFERENCES `tripdb_test`.`room_detail` (`roomdetail_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
...
create table gugun select * from enjoytrip.gugun;
create table attraction_detail select * from enjoytrip.attraction_detail;
create table attraction_description select * from enjoytrip.attraction_description;
create table attraction_info select * from enjoytrip.attraction_info;
create table sido select * from enjoytrip.sido;