...
public class RoomController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<RoomListResponseDto>> showSearchRoomList(@RequestParam String keyword, @AuthenticationPrincipal Member member) {
        log.info("SearchRoomList - GET");

        return ResponseEntity.ok().body(roomService.findAllByKeywordWithPicture(keyword));
    }
